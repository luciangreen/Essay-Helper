...
%%	choose_sentence_range(String00,),
	...
	concat_list(["In ",String01,", automation should apply to \"",String00a5,"\""%%<sup>.",End_note_number,"</sup>"%% (",String00a2,", p. ",N_page_ref,")."
	],Future_research),
...
%%choose_sentence_range(String00,N_page_ref,String00a1,String00a2,_String00a3,String00a4),
	...
	%%end_note_number(End_note_number),
	%%add_1_to_end_note_number,
	concat_list(["",String00a5%%,"<sup>",End_note_number,"</sup>"%%," (",String00a2,", p. ",N_page_ref,") "
	],Exposition2)
	%%reference(String00a1,String00a2,N_page_ref,End_note_number)
	),Exposition3),
...
exposition2(String00,Item1,ML_db,String3,String3a,String5a,String5):-
	...
	end_note_number(End_note_number),
	add_1_to_end_note_number,
	concat_list(["I agree with ",Item01," because ",String00a5,"<sup>",End_note_number,"</sup>."%%" (",String00a2,", p. ",N_page_ref,")."
	],String5a),
	reference(String00a1,String00a2,N_page_ref,End_note_number),
...
choose(N_page_ref1,String00a11,String00a21,_String00a31,_String00a41,String00a51),
	...
	"<sup>",End_note_number1,"</sup>."%%", p. ",N_page_ref1,")."
	],String5),
...
critique2(String00,String01,ML_db,String3,String3a,String5a,String3y,String3ay,String5a1,Topic_paragraph_link):-
	...
	end_note_number(End_note_number1),
	add_1_to_end_note_number,
	concat_list(["\"",String00a51,"\"<sup>",End_note_number1,"</sup>."%% (",String00a21,", p. ",N_page_ref1,")."
	],String5a),
	reference(String00a11,String00a21,N_page_ref1,End_note_number1),
	...
	concat_list(["\"",String00a52,"\"<sup>",End_note_number2,"</sup>."%% (",String00a22,", p. ",N_page_ref2,")."
	],String5a1),
...
CNumber2aa,CNumber3aa,CString5a1a,
	...
	add_1_to_end_note_number,
	concat_list(["\"",String00a54,"\"<sup>",End_note_number4,"</sup>."%% (",String00a24,", p. ",N_page_ref4,")."
	],String5a),
	...
	add_1_to_end_note_number,
	concat_list(["\"",String00a55,"\"<sup>",End_note_number5,"</sup>."%% (",String00a25,", p. ",N_page_ref5,")."
	],String5a1),
